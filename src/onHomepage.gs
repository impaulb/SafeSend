...
function onHomepage(e) {
  ...
  var overrideSelection = CardService.newSelectionInput()
    ...
    .addItem("SSN", "SSN", userSettings.overrideSSN === "true" ? true : false)
    .addItem("PHONE", "PHONE", userSettings.overridePHONE === "true" ? true : false)
    .addItem("EMAIL", "EMAIL", userSettings.overrideEMAIL === "true" ? true : false)
    .addItem("DATE", "DATE", userSettings.overrideDATE === "true" ? true : false)
    .addItem("VIN", "VIN", userSettings.overrideVIN === "true" ? true : false)
    .addItem("PASSPORT", "PASSPORT", userSettings.overridePASSPORT === "true" ? true : false)
    .addItem("MAC_ADDR", "MAC_ADDR", userSettings.overrideMAC_ADDR === "true" ? true : false)
...
function saveSettings(e) {
  ...
  const newSettings = {
    ...
    'overrideSSN': e.formInputs.overrideSelection.includes('SSN'),
    'overridePHONE': e.formInputs.overrideSelection.includes('PHONE'),
    'overrideEMAIL': e.formInputs.overrideSelection.includes('EMAIL'),
    'overrideDATE': e.formInputs.overrideSelection.includes('DATE'),
    'overrideVIN': e.formInputs.overrideSelection.includes('VIN'),
    'overridePASSPORT': e.formInputs.overrideSelection.includes('PASSPORT'),
    'overrideMAC_ADDR': e.formInputs.overrideSelection.includes('MAC_ADDR'),
    'override': JSON.stringify(e.formInputs.overrideSelection),
    'sensitivity': JSON.stringify(e.formInputs.sensitivitySelection),
    'advanced': JSON.stringify(e.formInputs.advancedSelection),
